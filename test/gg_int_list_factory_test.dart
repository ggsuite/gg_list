...
void main() {
  group('IntListFactory', () {
    // #########################################################################
    test(
      'should allow to create native int lists depending on a value range',
      () {
        // Uint8List
        ...
        final uint8SubList = uint8ListFactory.sublistView(
          uint8ListBuffer2,
          1,
          3,
        );
        ...
        // Uint16List
        final uint16ListFactory = GgIntListFactory(min: 0, max: 32767);
        ...
        final uint16SubList = uint16ListFactory.sublistView(
          uint16ListBuffer2,
          1,
          3,
        );
        ...
        // Uint32List
        final uint32ListFactory = GgIntListFactory(min: 0, max: 2147483647);
        ...
        final uint32SubList = uint32ListFactory.sublistView(
          uint32ListBuffer2,
          1,
          3,
        );
        ...
        // Int8List
        final int8ListFactory = GgIntListFactory(min: -128, max: 127);
        ...
        // Int16List
        final int16ListFactory = GgIntListFactory(min: -32768, max: 32767);
        ...
        final int16SubList = int16ListFactory.sublistView(
          int16ListBuffer2,
          1,
          3,
        );
        ...
        final int32SubList = int32ListFactory.sublistView(
          int32ListBuffer2,
          1,
          3,
        );
        ...
        final int64SubList = int64ListFactory.sublistView(
          int64ListBuffer2,
          1,
          3,
        );
